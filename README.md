...
The file fsmOutputTest.c explains what files to pass as command line arguments to test for different outputs.
All of the necessary input files are included here. 
